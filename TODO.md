...
- [x] Move skills out of here into their own repo set up
- [x] Manage claude in here, bonus means it now can't change it's own config!
- [x] ~~Look at sops nix for secrets (Github PAT, SSH keys, GPG etc.).~~ Faff, just use 1Password SSH agents
